...
exports.recordCustomMetric = (0, https_1.onCall)({
    ...
    try {
        ...
        firebase_functions_1.logger.info('Custom metric recorded successfully', {
            metricType,
            value,
...
exports.recordBatchMetrics = (0, https_1.onCall)({
    ...
    try {
        ...
        const timeSeriesArray = metrics.map((metric) => {
        ...
        firebase_functions_1.logger.info('Batch metrics recorded successfully', {
...
exports.collectSystemMetrics = (0, scheduler_1.onSchedule)({
    ...
    try {
        firebase_functions_1.logger.info('Starting system metrics collection');
        ...
        firebase_functions_1.logger.error('Failed to collect system metrics', {
            error: error instanceof Error ? error.message : 'Unknown error'
        });
    }
});
...
exports.createAlertingPolicy = (0, https_1.onCall)({
    ...
    try {
        const { metricType, threshold, comparisonType = 'COMPARISON_GREATER_THAN', displayName, notificationChannels = [] } = request.data;
